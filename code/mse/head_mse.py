...
def main():
    ...
    save_dir = '/public/home/acnebvshuq/js/occupant/norm/result/mse/headacc'
    os.makedirs(save_dir, exist_ok=True)
    ...
    # 保存头部加速度的scaler，用于后续反归一化
    import joblib
    scaler_path = os.path.join(save_dir, 'head_scaler.pkl')
    joblib.dump(scaler_head, scaler_path)
    print(f"头部加速度归一化器已保存至: {scaler_path}")
